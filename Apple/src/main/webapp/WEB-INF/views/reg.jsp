		...
		<div class="container">
			<form:form action="reg" method="post" commandName="user"
				...
				<div class="form-group">
					...
					<div class="col-lg-4 ">
						<form:input type="number" min="18" path="age" class="form-control"
				...
				<div class="form-group">
					...
					<div class="col-lg-4 ">
						<form:textarea class="form-control" type="text" rows="5" max="100"
							path="address" required="true"></form:textarea>
					</div>
				</div>
				<br>
				<br>
				...
				<div class="form-group">
					...
					<div class="col-lg-4 ">
						<form:password id="password1" path="password" class="form-control"
